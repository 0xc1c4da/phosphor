...
std::vector<Action> DefaultActions()
{
    ...
    return {
        ...
        // --- Colours / attributes ---
        {
            .id="colour.prev_fg", .title="Previous Foreground Colour", .category="Colour", .description="",
            .bindings={ {.enabled=true, .chord="Ctrl+Up", .context="editor", .platform="any"} }
        },
        {
            .id="colour.next_fg", .title="Next Foreground Colour", .category="Colour", .description="",
            .bindings={ {.enabled=true, .chord="Ctrl+Down", .context="editor", .platform="any"} }
        },
        {
            .id="colour.prev_bg", .title="Previous Background Colour", .category="Colour", .description="",
            .bindings={ {.enabled=true, .chord="Ctrl+Left", .context="editor", .platform="any"} }
        },
        {
            .id="colour.next_bg", .title="Next Background Colour", .category="Colour", .description="",
